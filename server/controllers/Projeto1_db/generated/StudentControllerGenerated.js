...
const generatedControllers = {
  ...
  init: router => {
    ...
    router.get(baseUrl + "/findByteachers/:key", authorize([]), StudentController.findByteachers);
  ...
  */
  findByteachers: async (req, res) => {
    try {
      const result = await StudentModel.findByteachers(req.params.key);
      res.json(result);
    } catch (err) {
      const safeErr = ErrorManager.getSafeError(err);
      res.status(safeErr.status).json(safeErr);
